...
var createMessage = module.exports.createMessage = function(ctx, meetingId, body, replyToCreatedTimestamp, callback) {
    ...
    _getMeeting(meetingId, function(err, meeting) {
        ...
        MeetingsAPI.Authz.canJoinMeetingMessage(ctx, meeting, function(err, canJoin) {
            if (err) {
                return callback(err);
            } else if (!canJoin) {
                return callback({'code': 401, 'msg': 'You are not authorized to post messages to this meeting'});
            }
