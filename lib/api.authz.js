 ...
 */
var canPostMeetingMessage = module.exports.canPostMeetingMessage = function(ctx, meeting, callback) {
    var user = ctx.user();
 ...
 */
var canDeleteMeetingMessage = module.exports.canDeleteMeetingMessage = function(ctx, meeting, message, callback) {
    var user = ctx.user();
 ...
 * @param  {Boolean}    callback.canPost    `true` if the user in context can post a message in the meeting. `false` otherwise.
 */
var resolveEffectiveMeetingAccess = module.exports.resolveEffectiveMeetingAccess = function(ctx, meeting, callback) {
    AuthzAPI.resolveEffectiveRole(ctx, meeting.id, meeting.tenant.alias, meeting.visibility, MeetingsConstants.roles.ALL_PRIORITY, function(err, effectiveRole, canInteract) {
        ...
        // Anyone who can "interact" with the meeting can post to it
